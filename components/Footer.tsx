...
export default function Footer() {
  return (
    <footer id='footer' className="w-full px-8 py-8 bg-[#fdf4ff] dark:bg-[#1c1c24] border-t border-[rgb(221,214,254)] dark:border-[#4b5563] flex flex-col items-center gap-4 text-center">
